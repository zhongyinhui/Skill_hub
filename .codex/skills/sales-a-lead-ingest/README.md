...
这个 skill 属于销售模块 A 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-a-lead-ingest/`。

## 适用场景

Use when a raw A-line source lead must be captured before customer binding, dedupe, or formal ledger entry.
