...
这个 skill 属于销售模块 E 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-e-news-radar/`。

## 适用场景

Use when E-line blacklight news scanning finds an AI, market, competitor, or customer-relevant news signal that should become an E output record.
