...
这个 skill 属于销售模块 A 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-a-reference-archive/`。

## 适用场景

Use when evidence, generated artifacts, or handoff references must be attached to existing A-line customer facts or snapshots.
...
- `scripts/a_sk08_reference_archive.py`
