...
这个 skill 属于销售模块 E 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-e-customer-activation/`。

## 适用场景

Use when E-line blacklight rules identify silent-customer, policy, or case activation opportunities from A-line customer snapshots.
...
- `scripts/e_bl03_customer_activation.py`
