...
这个 skill 属于销售模块 A 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-a-ready-validate/`。

## 适用场景

Use when a B-line a_ready_package must be checked before any facts are allowed to enter the formal A-line customer ledger.
...
- `scripts/a_sk05_ready_validate.py`
