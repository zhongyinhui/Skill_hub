...
这个 skill 属于销售模块 A 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-a-customer-bind/`。

## 适用场景

Use when an A-line sales lead has been accepted or confirmed and must be bound to an existing customer_id or converted into a new formal customer record.
...
- `scripts/a_sk02_customer_bind.py`
