...
这个 skill 属于销售模块 E 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-e-industry-radar/`。

## 适用场景

Use when E-line blacklight industry scanning finds a vertical-market AI adoption opportunity that should become an E output record.
...
- `scripts/e_bl11_industry_radar.py`
