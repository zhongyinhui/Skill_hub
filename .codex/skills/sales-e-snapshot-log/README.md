...
这个 skill 属于销售模块 E 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-e-snapshot-log/`。

## 适用场景

Use when E-line influence-factor history must be preserved as an E05 weekly snapshot or major-change log.
...
- `scripts/e_bl08_snapshot_and_change_log.py`
