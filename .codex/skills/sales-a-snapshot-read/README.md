...
这个 skill 属于销售模块 A 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-a-snapshot-read/`。

## 适用场景

Use when B-line, C-line, or E-line work needs a read-only A-line customer snapshot by customer_id.
...
- `scripts/a_sk10_snapshot_read.py`
