...
这个 skill 属于销售模块 E 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-e-influence-adjust/`。

## 适用场景

Use when E-line feedback must update active E05 influence-factor state for global, sales, weapon, or customer segment weights.
...
- `scripts/e_bl07_influence_adjust.py`
