...
这个 skill 属于销售模块 E 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-e-bline-sync-status/`。

## 适用场景

Use when E-line output rows need B-line action-map sync status, B-line refs, or sync errors written back.
...
- `scripts/e_bl15_bline_sync_status.py`
