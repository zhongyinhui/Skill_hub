...
这个 skill 属于销售模块 A 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-a-self-customer-dedupe/`。

## 适用场景

Use when a salesperson reports a self-developed or no-source customer and A-line must dedupe candidates before creating a formal customer record.
...
- `scripts/a_sk03_self_customer_dedupe.py`
