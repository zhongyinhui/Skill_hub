...
这个 skill 属于销售模块 E 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-e-case-activation/`。

## 适用场景

Use when E-line blacklight case matching finds a customer activation opportunity based on an existing case or D-line proof asset.
...
- `scripts/e_bl12_case_activation.py`
