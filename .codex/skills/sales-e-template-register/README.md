...
这个 skill 属于销售模块 E 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-e-template-register/`。

## 适用场景

Use when E-line output templates or schemas must be registered, versioned, or validated in the E06 template index.
...
- `scripts/e_bl14_template_register.py`
