...
这个 skill 属于销售模块 A 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-a-controlled-repair/`。

## 适用场景

Use when A-line audit findings need confirmed repair, backfill, or reference maintenance without changing existing skill behavior.
...
- `scripts/a_sk12_controlled_repair.py`
