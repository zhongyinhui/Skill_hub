...
这个 skill 属于销售模块 A 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-a-snapshot-refresh/`。

## 适用场景

Use when A-line must refresh latest_snapshot_text or latest_snapshot_json after validated customer ledger changes.
...
- `scripts/a_sk09_snapshot_refresh.py`
