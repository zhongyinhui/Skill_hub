...
这个 skill 属于销售模块 E 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-e-feedback-capture/`。

## 适用场景

Use when B-line adoption, customer response, C-line effect, or D-line feedback must be written back to E01.2 output records.
...
- `scripts/e_bl06_feedback_capture.py`
