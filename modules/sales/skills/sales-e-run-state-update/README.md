...
这个 skill 属于销售模块 E 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-e-run-state-update/`。

## 适用场景

Use when E-line blacklight task run state, last-run status, next-run time, or batch error summary must be written to E01.
...
- `scripts/e_bl16_run_state_update.py`
