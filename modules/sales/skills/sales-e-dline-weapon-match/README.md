...
这个 skill 属于销售模块 E 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-e-dline-weapon-match/`。

## 适用场景

Use when E-line blacklight matching must recommend existing D-line weapons or skill IDs for a customer opportunity.
...
- `scripts/e_bl04_dline_weapon_match.py`
