...
这个 skill 属于销售模块 A 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-a-alias-map/`。

## 适用场景

Use when customer aliases, names, phone or source identifiers must be normalized and mapped to a formal A-line customer_id.
