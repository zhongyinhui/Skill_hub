...
这个 skill 属于销售模块 E 线，已按 Skill Hub 正式路径归档到 `modules/sales/skills/sales-e-opportunity-scan/`。

## 适用场景

Use when E-line blacklight scanning finds external news, policy, industry, or source signals that must become E01.2 opportunity output records.
...
- `scripts/e_bl02_opportunity_scan.py`
